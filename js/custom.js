(function() {
  ...
  */
  tl.from(headerHome, 0.4, {
      y: 1000,
      ease: Sine.easeOut
    })
    .from(headerMenu, 0.55, {
      y: 200,
      autoAlpha: 0,
      ease: Sine.easeOut
    })
    .from(headerDivider, 0.55, {
      y: 200,
      autoAlpha: 0,
      ease: Sine.easeOut
    })
    .from(centerBigHeader, 0.55, {
      y: 200,
      autoAlpha: 0,
      ease: Sine.easeOut
    })
    .from(centerContentHeader, 0.55, {
      y: 500,
      autoAlpha: 0,
      ease: Sine.easeOut
    })
    .from(chapeterIcon, 0.55, {
      y: 500,
      autoAlpha: 0,
      ease: Sine.easeOut
    })
    .from(scrollIconHeader, 0.55, {
      y: 200,
      autoAlpha: 0,
      ease: Sine.easeOut
    })
  ...
  function openMenu() {
    ...
    tl.from(menuBottomTitle, 0.3, {
      ...
      .from(menuBottomText, 0.3, {
        autoAlpha: 0,
        x: -1000,
        ease: Expo.easeOut
      })
      .staggerFromTo(menuItems, 0.8, {
        autoAlpha: 0,
        x: -1000
      }, {
        autoAlpha: 1,
  ...
  chapeterIcon.on('click', function() { //kilk na .chapter_icon
  ...
  $('.popup_close').on('click', function() { // klik na .popup_close
  ...
  $('.about_btn').on('click', function() {
    TweenMax.to(aboutSlide, 2, {
      x: "0%",
      ease: Power4.easeOut
    });
    TweenMax.fromTo(animateSlide, 2, {
      x: '100%',
      ease: Power4.easeOut,
      delay: 0.5
    }, {
  ...
  $('.about_slide_close').on('click', function() {
    TweenMax.to(aboutSlide, 2, {
      x: '100%',
  ...
  var scene = new ScrollMagic.Scene({
    ...
    .setTween(TweenMax.from('.about_box', 1, {
      y: '50%',
      autoAlpha: 0,
      ease: Expo.easeOut
    }))
